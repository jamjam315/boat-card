...
def compare_table(race, players):
    ...
    return (f'<div class="cmp"><div class="cmp-ttl">比べる一覧</div>'
            ...
            f'<th class="cmp-num">全国<br>勝率</th><th class="cmp-num">ﾓｰﾀｰ<br>2率</th>'
            f'<th class="cmp-num cmp-st"><span class="cmp-st-inner"><span class="cmp-st-val">ST</span><span class="cmp-stl"></span></span></th></tr></thead>'
...
def refresh_sitemap():
    ...
    urls = ["https://teiyomi.com/", "https://teiyomi.com/guide.html", "https://teiyomi.com/privacy.html",
            "https://teiyomi.com/about.html", "https://teiyomi.com/players/", "https://teiyomi.com/backtest.html",
            "https://teiyomi.com/backtest-custom.html"]
    try:
